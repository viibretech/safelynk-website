    ...
    <section id="footer" className="bg-white px-5 lg:px-40 pt-20 pb-10">
      <div className="">
        <div className="space-y-3">
          ...
          <div
            id="parent-company"
            className="text-xs mt-7 font-inter-bold text-divider-600"
          >
            ...
            <div className="font-inter-regular">
              Viibre Technologies helps businesses grow with smart, tailored
              software solutions that streamline operations, enhance
              experiences, and drive results. We don’t just build software — we
              design digital solutions that strengthen every part of your
              business. Our focus areas ensure you get measurable results where
              it matters most.
            </div>
          </div>
        </div>
