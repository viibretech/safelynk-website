        ...
        <div className="max-w-4xl mx-auto pb-20 text-gray-700 space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              the information you provide to us when accessing or using our
              platform.
            </p>
            <p>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              using our service. In order to achieve this, we may collect
              certain personally identifiable information from you. This
              information may include, but is not limited to: full name, e-mail
              address, phone number, business details. This also includes
              information you provide through your continued use of our
              services, your participation in discussion boards or other social
              media functions on our website, mobile app or other tools through
              entering a competition, promotion or survey, and by reporting
              problems with our services. Additionally, you may be asked to
              provide information about your buyer as part of our service
              offerings.
            </p>
            <p>
              Please note that Safelynk may utilize other third-party services
              to enhance your experience. These services may collect information
              and use it to identify you. It’s important to understand that
              these third-party services operate under their own privacy
              policies, which may differ from ours. We encourage you to review
              the privacy policies of any third-party service providers utilized
              by Safelynk to understand how your information is handled. While
              we strive to partner with reputable service providers, we cannot
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              belonging to our partner networks, advertisers, and affiliates.
              It’s important to note that these external websites have their own
              privacy policies, which may differ from ours.
            </p>
            <p>
              We want to emphasize that Safelynk does not assume any
              responsibility or liability for the privacy practices or policies
              of these external websites. Therefore, we encourage you to review
              the privacy policies of these websites before submitting any
          ...
          <section className="space-y-4">
            ...
            <p>
              As a user of Safelynk, you also play a crucial role in
              safeguarding your personal and business information. We urge you
              to take the following precautions:
            </p>
            <ul className="list-disc ml-6 space-y-2">
              <li>
                Safeguard your Safelynk account password and refrain from
              ...
              <li>
                ...
                your Safelynk account or detect a security breach.
              </li>
            </ul>
            <p>
              Please be aware that if we receive instructions using your
              Safelynk account login information, we will consider those
          ...
          <section className="space-y-4">
            ...
            <p>
              Safelynk may disclose personally identifiable information in
