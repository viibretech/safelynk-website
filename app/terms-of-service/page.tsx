...
// Assuming Header is a component defined elsewhere
// import Header from './Header';

// This assumes you are in a Next.js or React environment with Tailwind CSS configured.
      ...
      <div className="max-w-4xl mx-auto pb-20 text-gray-700 space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            Website. This Agreement is a contract between you (“you,” “your,” or
            “user”) and Viibre Technology LTD (“Safelynk,” “we,” “us,” “our,” or
            “The Company”) and applies to your use of:
          </p>
          <ul className="list-lower-alpha ml-6 space-y-2">
            <li>
              the Website and any associated Safelynk-hosted websites or mobile
              applications, and
            </li>
            <li>
          ...
          <p>
            ...
            register, access, or use the Website (the “Effective Date”). Before
            registering, accessing, or using the Website, please read on. By
            registering, accessing, or using the Website or any tools provided
            herein, you accept the terms and conditions outlined in this
            Agreement. If you do not agree to the Agreement, you may not access
            the Website or tools. If you use any of the services offered on the
            Website or mobile app on behalf of a business, you represent and
            warrant that you can enter into this Agreement with Safelynk on
            behalf of that business, that you accept the terms and conditions
            contained herein on behalf of that business, and that you have
        ...
        <section className="space-y-4">
          ...
          <p>
            You agree to the terms of the Safelynk privacy policy (available at{" "}
            <a
        ...
        <section className="space-y-4">
          ...
          <p>
            Unauthorized use of the materials on the Website or tools, including
            reproduction, modification, distribution, or republication, is
            strictly prohibited without prior written permission from Safelynk.
          </p>
          <p>
            Users are granted a nonexclusive and nontransferable license to
            access and use the Website, mobile app and tools electronically, as
            described in this Agreement. Safelynk does not grant the right to
            sublicense any of its intellectual property.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            and obligations to ensure proper use of the platform. These include:
          </p>
          ...
          <p className="pl-4">
            ...
            engaging in activities that violate laws, regulations, or the rights
            of others, including intellectual property rights or rights of
            privacy.
          </p>
          ...
          <p className="pl-4">
            Users are prohibited from submitting or linking to any content that
            violates privacy or publicity rights of others. Additionally, users
            may not use the Website or tools to develop products or services
            that compete with Safelynk or its Services, or engage in practices
            that discriminate against or discourage the use of Safelynk’s
            Services.
          </p>
          ...
          <p className="pl-4">
            Users must not promote or engage in activities related to prohibited
            goods or services, including spyware, counterfeit goods, hate
            materials, hacking tools, illegal substances, or weapons. The
            Website, mobile app and tools may not be used for illegal purposes
            or to promote illegal activities.
          </p>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            partners to understand how their personal information is collected,
            used, and protected during the payment process. It&apos;s essential
            to note that all fees charged by Safelynk are exclusive of any
            applicable taxes, levies, or duties imposed by taxing authorities.
            Users are responsible for the payment of any such taxes, levies, or
            duties associated with their use of the platform and its services.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            notice. Safelynk shall not be held liable to you or any third party
            for any modifications, changes in pricing, suspension, or
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            . Notices to you will be delivered to the email address provided to
            Safelynk.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            your Personal Information or this Terms of Service, you may contact
            us by:
          </p>
