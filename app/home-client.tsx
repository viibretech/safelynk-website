...
import {
  SAFELYNK_APP_STORE_URL,
  SAFELYNK_PLAY_STORE_URL,
} from "@/lib/app-stores";
    ...
    <div>
      ...
      >
        <div className="absolute inset-0 w-full h-full">
          <Image
            ...
            alt="People collaborating over a secure digital payment and escrow experience"
            radius="none"
          ...
          <div className="flex flex-col sm:h-screen h-[80vh]">
            ...
            <div className="h-full flex flex-col justify-center lg:px-40 px-5">
              <div className="max-w-md space-y-3">
                <h1 className="text-2xl transition-all md:text-5xl font-inter-display-bold">
                  Rebuilding Trust in <br /> Digital Trade
                </h1>
                <p className="sm:max-w-md text-xs mt-3 font-inter-light">
        ...
        <div className="grid grid-row-2 grid-cols-1">
          <div className="flex gap-y-5 sm:space-y-0 flex-col-reverse sm:flex-row sm:space-x-4 justify-between">
            <div className="flex flex-col">
              <div className="space-y-3">
                <h2 className="text-2xl transition-all md:text-4xl font-inter-display-bold">
                  We Hold the Money
            ...
            <div className="flex justify-center">
              <Image
                ...
                alt="Shield icon representing payment protection and escrow security"
          ...
          <div className="grid grid-rows-3 grid-cols-1 sm:grid-rows-1 sm:grid-cols-3 mt-10 sm:mt-12 gap-x-4 gap-y-6">
            <div className="flex flex-col items-start space-y-3 max-w-xs">
              ...
              />
              <p className="text-divider-600 tracking-[-1.1] text-xs">
      ...
      <section id="how-it-works" className="bg-white px-5 lg:px-40 py-10">
        <div className="">
          <div className="flex flex-col items-center ">
            ...
            <p className="sm:max-w-md text-xs mt-3 tracking-[-1.1] text-divider-600 text-center">
          ...
          <div className="flex flex-col w-full space-y-6 justify-center md:flex-row mt-10 md:space-y-0 md:space-x-10">
            ...
            <Card
              ...
              desc="The buyer pays through Safelynk using the link. Funds are held in escrow until the deal is completed or cancelled according to your agreement."
            />
            <Card
              index="3"
              title="Complete & Confirm"
              desc="Once the buyer confirms delivery or completion, Safelynk releases the funds to the seller."
            />
          </div>
        </div>
      </section>
      <div className="relative w-full pb-20 overflow-hidden">
        ...
        <div className="flex justify-center relative z-10">
          <div className="flex flex-col items-center w-100 sm:w-160 text-center">
            <h2 className="text-6xl md:text-[135px] sm:text-[100px] transition-all font-inter-display-bold">
              <span className="block">Over 80%</span>
              <span className="block text-2xl md:text-4xl sm:text-3xl mt-2 md:mt-4">
                of payment fraud starts online
              </span>
            </h2>
            <p className="sm:max-w-md mt-3 text-divider-600 text-xs">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-inter-display-bold text-center">
          {!isMobile && (
            <>
        ...
        <div className="absolute inset-0 px-5 h-full lg:px-40 py-16 z-40">
          <div className="bg-white flex justify-center rounded-2xl h-full">
            <div className="flex flex-col justify-center items-center space-y-7">
              <h2 className="text-2xl transition-all md:text-4xl font-inter-display-bold text-center">
                {!isMobile && (
                  <>
              ...
              <div className="flex items-center border-1 border-divider-300 px-5 py-3 max-w-60 rounded-2xl">
                ...
                <Image
                  ...
                  alt="QR code to download the Safelynk mobile app"
              ...
              <div className="flex justify-center space-x-4">
                <SocialButton
                  ...
                  text2="App Store"
                  url={SAFELYNK_APP_STORE_URL}
                />
                <SocialButton
                  imagePath="svgs/google.svg"
                  text1="GET IT ON"
                  text2="Google Play"
                  url={SAFELYNK_PLAY_STORE_URL}
                />
              </div>
            </div>
          </div>
      ...
      <section id="faqs" className="bg-white px-5 lg:px-40 py-20">
        <div className="flex flex-col items-start sm:grid sm:grid-rows-1 sm:grid-cols-2">
          <div className="flex flex-col space-y-3 items-start">
            <h2 className="text-4xl transition-all sm:text-6xl font-inter-medium">
              {isDesktop && (
                <>
